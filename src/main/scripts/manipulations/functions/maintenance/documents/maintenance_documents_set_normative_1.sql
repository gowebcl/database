...
<header>
<rule>Ley 19537</rule>
<publication>16-12-1997</publication>
<promulgation>05-12-1997</promulgation>
<organism>MINISTERIO DE VIVIENDA Y URBANISMO</organism>
<title>SOBRE COPROPIEDAD INMOBILIARIA</title>
<version>30-05-2015</version>
<validity>30-05-2015</validity>
<id>81505</id>
<modification>30-MAY-2015 Ley 20841</modification>
<url>https://www.leychile.cl/Navegar?idNorma=81505</url>
</header>
<body>
<title>
<number>I</number>
<text>Del régimen de copropiedad inmobiliaria</text>
<chapter>
<paragraph>
<article>
<number>1</number>
<text>La presente ley regula un régimen especial de propiedad inmobiliaria, con el objeto de establecer condominios integrados por inmuebles divididos en unidades sobre las cuales se pueda constituir dominio exclusivo a favor de distintos propietarios, manteniendo uno o más bienes en el dominio común de todos ellos.
...
Sólo las unidades que integran condominios acogidos al régimen de copropiedad inmobiliaria que consagra la presente ley podrán pertenecer en dominio exclusivo a distintos propietarios.</text>
</article>
<article>
<number>1 bis</number>
<text>Al Ministerio de la Vivienda y Urbanismo corresponderá, a través de la División de Desarrollo Urbano, impartir, mediante circulares, que se mantendrán a disposición de cualquier interesado, las instrucciones para la aplicación de las disposiciones de esta ley y su reglamento, en materias relacionadas con autorizaciones municipales, proyectos de construcción y obras de condominios.</text>
</article>
<article>
<number>2</number>
<text>Para los efectos de esta ley, se entenderá por:
...
8. Administrador: la persona natural o jurídica designada por los copropietarios para cumplir labores de administración del condominio, conforme a la presente ley, a su reglamento y al reglamento de copropiedad.</text>
</article>
<article>
<number>3</number>
<text>Cada copropietario será dueño exclusivo de su unidad y comunero en los bienes de dominio común.
...
En caso de condominios que contemplen diferentes sectores, el reglamento podrá establecer los derechos de las unidades sobre los bienes comunes del respectivo sector, separadamente de los derechos sobre los bienes comunes de todo el condominio.</text>
</article>
<article>
<number>4</number>
<text>Cada copropietario deberá contribuir tanto a los gastos comunes ordinarios como a los gastos comunes extraordinarios, en proporción al derecho que le corresponda en los bienes de dominio común, salvo que el reglamento de copropiedad establezca otra forma de contribución.
...
Si, por no contribuirse oportunamente a los gastos a que aluden los incisos anteriores, se viere disminuido el valor del condominio, o surgiere una situación de riesgo o peligro no cubierto, el copropietario causante responderá de todo daño o perjuicio.</text>
</article>
<article>
<number>5</number>
<text>Cada copropietario deberá pagar los gastos comunes con la periodicidad y en los plazos que establezca el reglamento de copropiedad. Si incurriere en mora, la deuda devengará el interés máximo convencional para operaciones no reajustables o el inferior a éste que establezca el reglamento de copropiedad.
...
El uso y goce exclusivo no autorizará al copropietario titular de estos derechos para efectuar construcciones o alteraciones en dichos bienes, o para cambiar su destino, sin contar previamente con permiso de la Dirección de Obras Municipales.</text>
</article>
<article>
<number>14</number>
<text>Los derechos de cada copropietario en los bienes de dominio común son inseparables del dominio exclusivo de su respectiva unidad y, por tanto, esos derechos se entenderán comprendidos en la transferencia del dominio, gravamen o embargo de la respectiva unidad. Lo anterior se aplicará igualmente respecto de los derechos de uso y goce exclusivos que se le asignen sobre los bienes de dominio común.
...
Asimismo, las alteraciones o transformaciones que afecten a las instalaciones de ascensores, tanto verticales como inclinados o funiculares, montacargas y escaleras o rampas mecánicas, sean en bienes de dominio común o en las unidades de los condominios, deberán ser ejecutadas por empresas o personas que cuenten con una inscripción vigente en el registro de instaladores, mantenedores y certificadores del Ministerio de Vivienda y Urbanismo y contar con el acuerdo de la asamblea de copropietarios y el permiso de la Dirección de Obras Municipales, cuando corresponda.</text>
</article>
<article>
<number>14 ter</number>
<text>La tramitación de solicitudes ante la Dirección de Obras Municipales se efectuará conforme a lo establecido en la Ordenanza General de Urbanismo y Construcciones.</text>
</article>
<article>
<number>15</number>
<text>Para cambiar el destino de una unidad, se requerirá que el nuevo uso esté permitido por el instrumento de planificación territorial y que el copropietario obtenga, además del permiso de la Dirección de Obras Municipales, el acuerdo previo de la asamblea.</text>
</article>
<article>
<number>16</number>
<text>Las unidades de un condominio podrán hipotecarse o gravarse libremente, sin que para ello se requiera acuerdo de la asamblea, subsistiendo la hipoteca o gravamen en los casos en que se ponga término a la copropiedad.
...
La inscripción de la hipoteca o gravamen de una unidad contendrá, además de las menciones señaladas en los números 1º, 2º, 4º y 5º del artículo 2432 del Código Civil, las que se expresan en los números 4) y 5) del inciso segundo del artículo 12 de esta ley.</text>
</article>
</paragraph>
</chapter>
<chapter>
<number>II</number>
<text>De la administración de los condominios</text>
<paragraph>
<article>
<number>17</number>
<text>Todo lo concerniente a la administración del condominio será resuelto por los copropietarios reunidos en asamblea, sin perjuicio de los demás mecanismos contemplados en esta ley.
...
Tratándose de la primera asamblea, ésta será presidida por el administrador, si lo hubiere, o por el copropietario asistente que designe la asamblea mediante sorteo.</text>
</article>
<article>
<number>19</number>
<text>Las asambleas ordinarias se constituirán en primera citación con la asistencia de los copropietarios que representen, a lo menos, el sesenta por ciento de los derechos en el condominio; y en segunda citación, con la asistencia de los copropietarios que concurran, adoptándose en ambos casos los acuerdos respectivos por la mayoría absoluta de los asistentes.
...
Si no se reunieren los quórum necesarios para sesionar o para adoptar acuerdos, el administrador o cualquier copropietario podrá ocurrir al juez conforme a lo previsto en el artículo 33.</text>
</article>
<article>
<number>20</number>
<text>Todo copropietario estará obligado a asistir a las asambleas respectivas, sea personalmente o debidamente representado, según se establezca en el reglamento de copropiedad. Si el copropietario no hiciere uso del derecho de designar apoderado o, habiéndolo designado, éste no asistiere, para este efecto se entenderá que acepta que asuma su representación el arrendatario o el ocupante a quien hubiere entregado la tenencia de su unidad, siempre que en el respectivo contrato así se hubiere establecido.
...
El administrador estará obligado a rendir cuenta documentada de su administración en las épocas que se le hayan fijado y, además, cada vez que se lo solicite la asamblea de copropietarios o el Comité de Administración, en su caso, y al término de su gestión. Para estos efectos, los copropietarios tendrán acceso a la documentación correspondiente.</text>
</article>
<article>
<number>24</number>
<text>Mientras se proceda al nombramiento del Comité de Administración, cualquiera de los copropietarios podrá ejecutar por sí solo los actos urgentes de administración y conservación.</text>
</article>
<article>
<number>25</number>
<text>El reglamento de copropiedad o la asamblea podrán establecer subadministraciones en un mismo condominio, debiendo siempre mantenerse una administración central. Para estos efectos, la porción del condominio correspondiente a cada subadministración deberá constar en un plano complementario de aquel a que se refiere el artículo 11. El reglamento de copropiedad especificará las funciones de las subadministraciones y su relación con la administración central.</text>
</article>
<article>
<number>26</number>
<text>Dos o más condominios ubicados en una misma comuna podrán convenir su administración conjunta, previo acuerdo adoptado en asamblea extraordinaria especialmente citada al efecto.
...
El acuerdo y el convenio señalados deberán reducirse a escritura pública, siendo aplicables a ellos las mismas normas que regulan el reglamento de copropiedad.</text>
</article>
<article>
<number>27</number>
<text>La copia del acta de la asamblea válidamente celebrada, autorizada por el Comité de Administración, o en su defecto por el administrador, en que se acuerden gastos comunes, tendrá mérito ejecutivo para el cobro de los mismos. Igual mérito tendrán los avisos de cobro de dichos gastos comunes, extendidos de conformidad al acta, siempre que se encuentren firmados por el administrador.
Demandadas estas prestaciones, se entenderán comprendidas en la acción iniciada las de igual naturaleza a las reclamadas, que se devengaren durante la tramitación del juicio.</text>
</article>
<article>
<number>28</number>
<text>Los copropietarios de un condominio deberán acordar un reglamento de copropiedad con los siguientes objetos:
...
<article>
<number>30</number>
<text>Una vez enajenado el 75% de las unidades que formen parte de un condominio nuevo, el Administrador deberá convocar a Asamblea extraordinaria la que se pronunciará sobre la mantención, modificación o sustitución del Reglamento a que se refiere el artículo precedente.
...
Las normas del reglamento de copropiedad serán obligatorias para los copropietarios, para quienes les sucedan en el dominio y para los ocupantes de las unidades a cualquier título.</text>
</article>
<article>
<number>31</number>
<text>Los copropietarios que se sientan afectados por disposiciones del reglamento de copropiedad del condominio, por estimar que ha sido dictado con infracción de normas de esta ley o de su reglamento, o que contiene disposiciones contradictorias o que no corresponden a la realidad de ese condominio o de manifiesta arbitrariedad en el trato a los distintos copropietarios, podrán demandar ante el tribunal que corresponda de acuerdo a los artículos 33 y 34 de esta ley, la supresión, modificación o reemplazo de las normas impugnadas. La acción se notificará al administrador del condominio que para estos efectos tendrá la calidad de representante legal de los restantes copropietarios, debiendo ponerla en conocimiento de cada uno de los copropietarios, dentro de los cinco días hábiles siguientes a dicha notificación, mediante comunicación escrita dirigida al domicilio registrado por éstos en la administración o a falta de éste, a la respectiva unidad. En todo caso, cualquier copropietario podrá hacerse parte en el juicio.</text>
</article>
<article>
<number>32</number>
<text>Los copropietarios, arrendatarios u ocupantes a cualquier título de las unidades del condominio, deberán ejercer sus derechos sin restringir ni perturbar el legítimo ejercicio de los derechos de los demás ocupantes del condominio.
...
El cobro de gastos comunes se sujetará al procedimiento del juicio ejecutivo del Título I del Libro Tercero del Código de Procedimiento Civil y su conocimiento corresponderá al juez de letras respectivo.</text>
</article>
<article>
<number>34</number>
<text>Sin perjuicio de lo dispuesto en el artículo anterior, las contiendas a que se refiere el inciso primero de dicho artículo, podrán someterse a la resolución del juez árbitro arbitrador a que se refiere al artículo 223 del Código Orgánico de Tribunales. En contra de la sentencia arbitral, se podrán interponer los recursos de apelación y de casación en la forma, conforme a lo previsto en el artículo 239 de ese mismo Código.
El árbitro deberá ser designado por acuerdo de la asamblea y, a falta de acuerdo, por el juez letrado de turno, pudiendo ser sustituido o removido en cualquier momento por acuerdo de la asamblea, siempre que no esté conociendo causas pendientes.</text>
</article>
<article>
<number>35</number>
<text>La respectiva municipalidad podrá atender extrajudicialmente los conflictos que se promuevan entre los copropietarios o entre éstos y el administrador, y al efecto estará facultada para citar a reuniones a las partes en conflicto para que expongan sus problemas y proponer vías de solución, haciendo constar lo obrado y los acuerdos adoptados en actas que se levantarán al efecto. La copia del acta correspondiente, autorizada por el secretario municipal respectivo, constituirá plena prueba de los acuerdos adoptados y deberá agregarse al libro de actas del Comité de Administración. En todo caso la municipalidad deberá abstenerse de actuar si alguna de las partes hubiere recurrido o recurriera al juez de policía local o a un árbitro, conforme a lo dispuesto en los artículos 33 y 34 de esta ley.</text>
</article>
</paragraph>
</chapter>
<chapter>
<number>III</number>
<text>De la seguridad del condominio y del término o modificación de la copropiedad inmobiliaria</text>
<paragraph>
<article>
<number>36</number>
<text>Salvo que el reglamento de copropiedad establezca lo contrario, todas las unidades de un condominio deberán ser aseguradas contra riesgo de incendio, incluyéndose en el seguro los bienes de dominio común en la proporción que le corresponda a la respectiva unidad. Cada copropietario deberá contratar este seguro y, en caso de no hacerlo, lo contratará el administrador por cuenta y cargo de aquél, formulándole el cobro de la prima correspondiente conjuntamente con el de los gastos comunes, indicando su monto en forma desglosada de éstos. Al pago de lo adeudado por este concepto, se aplicarán las mismas normas que rigen para los gastos comunes.
...
El Director de Obras Municipales tendrá un plazo de treinta días corridos para pronunciarse sobre la solicitud a que se refiere el inciso anterior, contado desde la fecha de la presentación de la misma. Será aplicable a este requerimiento lo dispuesto en los incisos segundo, tercero y cuarto del artículo 118 del decreto con fuerza de ley Nº 458, de 1975, Ley General de Urbanismo y Construcciones.</text>
</article>
</paragraph>
</chapter>
<chapter>
<number>IV</number>
<text>De los condominios de viviendas sociales</text>
<paragraph>
<article>
<number>39</number>
<text>Los condominios de viviendas sociales se regirán por las disposiciones especiales contenidas en este Título y, en lo no previsto por éstas y siempre que no se contrapongan con lo establecido en ellas, se sujetarán a las normas de carácter general contenidas en los restantes Títulos de esta ley.
...
Se considerarán condominios de viviendas sociales aquellos conjuntos que estén constituidos mayoritariamente por viviendas sociales.</text>
</article>
<article>
<number>39 bis</number>
<text>En los predios que originalmente contaron con una vivienda social podrán contemplarse, por una sola vez, hasta dos viviendas sociales adicionales y constituir un condominio acogido a la presente ley, bajo la denominación de "condominio de densificación predial".
...
Todo lo concerniente a la administración del condominio corresponderá a los copropietarios, que deberán actuar conjuntamente en todas aquellas materias que puedan afectar a más de una unidad. Tratándose de obras relacionadas con las condiciones de habitabilidad o de seguridad, el Director de Obras Municipales podrá autorizar su ejecución a solicitud de uno solo de los copropietarios afectados.</text>
</article>
<article>
<number>40</number>
<text>Para los efectos de este Título, se considerarán viviendas sociales las viviendas económicas de carácter definitivo, destinadas a resolver los problemas de la marginalidad habitacional, cuyo valor de tasación no exceda en más de un 30% el señalado en el decreto ley Nº 2.552, de 1979.
...
2. El valor de construcción de la vivienda, según el proyecto presentado, que se evaluará conforme a la tabla de costos unitarios a que se refiere el artículo 127 de la ley General de Urbanismo y Construcciones.</text>
</article>
<article>
<number>41</number>
<text>Los Gobiernos Regionales, las Municipalidades y los Servicios de Vivienda y Urbanización podrán destinar recursos a condominios de viviendas sociales emplazados en sus respectivos territorios.
...
Tratándosede condominios que no se encuentren organizados, para la postulación a dichos programas bastará la firma de los copropietarios que representen, al menos, la mitad de los derechos en el condominio.</text>
</article>
<article>
<number>42</number>
<text>Los Gobiernos Regionales, las Municipalidades y los Servicios de Vivienda y Urbanización respectivos podrán designar, por una sola vez, en los condominios de viviendas sociales que carezcan de administrador, una persona que actuará provisionalmente como administrador, con las mismas facultades y obligaciones que aquél.
...
La municipalidad deberá entregar copia autorizada de tales documentos a cualquier copropietario, miembro del Comité de Administración o administrador del respectivo condominio, a los funcionarios del Servicio de Vivienda y Urbanización o del Gobierno Regional, a costa del requirente.</text>
</article>
<article>
<number>45</number>
<text>Las empresas que proporcionen servicios de energía eléctrica, agua potable, alcantarillado, gas u otros servicios, a un condominio de viviendas sociales, deberán cobrar, conjuntamente con las cuentas particulares de cada vivienda, la proporción que le corresponda a dicha unidad en los gastos comunes por concepto del respectivo consumo o reparación de estas instalaciones. Esta contribución se determinará en el respectivo reglamento de copropiedad o por acuerdo de la asamblea de copropietarios, conforme a lo dispuesto en el artículo 4º.
...
Los cobros de gastos comunes que efectúen las citadas empresas de servicios, en su caso, deberán efectuarse en documento separado del cobro de los servicios. Los convenios respectivos deberán archivarse en el registro municipal a que se refiere el artículo 44 bis.</text>
</article>
<article>
<number>46</number>
<text>Tratándose de condominios de viviendas sociales integrados por más de un bloque independiente, cada bloque podrá formar un sector y establecer subadministraciones, cualquiera que sea el número de unidades que lo integren.
En caso que no estuviere establecido en el reglamento de copropiedad, en el acta de constitución de la subadministración deberán consignarse sus funciones y la relación con el resto del condominio. Dicha acta requerirá la firma de un ministro de fe.</text>
</article>
<article>
<number>46 bis</number>
...
Los condominios de viviendas sociales estarán exentos del pago de los derechos municipales que pudieren devengarse respecto de las actuaciones del ministro de fe, en su caso.</text>
</article>
<article>
<number>46 ter</number>
<text>En los condominios a que se refiere este Título, la municipalidad correspondiente estará obligada a actuar como instancia de mediación extrajudicial, conforme a lo establecido en el artículo 35, y a proporcionar su asesoría para la organización de los copropietarios. Para estos efectos, la municipalidad podrá celebrar convenios con instituciones públicas o privadas.</text>
</article>
<article>
<number>46 quáter</number>
<text>Facúltase a las municipalidades para subdividir los condominios de viviendas sociales, conforme a lo dispuesto en el artículo 39.
...
Los condominios de viviendas sociales estarán exentos del pago de los derechos municipales que pudieren devengarse respecto de las actuaciones a que se refiere este artículo.</text>
</article>
</paragraph>
</chapter>
<chapter>
