drop function if exists maintenance_indicators_get_euro;

create or replace function maintenance_indicators_get_euro (
...
begin
    ...
    var_txt_function = 'maintenance_indicators_get_euro';
