drop function if exists environment_core_get_previous_month;

create or replace function environment_core_get_previous_month (
...
begin
    ...
    return to_char (var_tim_offset - make_interval (0, in_num_offset::integer), 'mm')::numeric;
