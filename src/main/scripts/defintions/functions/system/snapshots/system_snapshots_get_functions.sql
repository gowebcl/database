drop function if exists system_documentation_get_functions;

create or replace function system_documentation_get_functions (
    in incoming_object json
)
returns json as $body$
declare
    outgoing_object json;
    var_txt_function text = 'system_documentation_get_functions';
