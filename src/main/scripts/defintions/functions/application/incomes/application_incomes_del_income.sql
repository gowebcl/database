drop function if exists application_incomes_del_income;

create or replace function application_incomes_del_income (
...
declare
    ...
    var_txt_function text = 'application_incomes_del_income';
