drop function if exists application_incomes_set_income;

create or replace function application_incomes_set_income (
...
declare
    ...
    var_txt_function text = 'application_incomes_set_income';
