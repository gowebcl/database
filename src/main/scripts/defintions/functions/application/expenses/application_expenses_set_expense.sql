drop function if exists application_expenses_set_expense;

create or replace function application_expenses_set_expense (
...
declare
    ...
    var_txt_function text = 'application_expenses_set_expense';
