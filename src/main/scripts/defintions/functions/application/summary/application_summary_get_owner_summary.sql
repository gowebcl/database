drop function if exists application_summary_get_owner_summary;

create or replace function application_summary_get_owner_summary (
...
declare
  ...
  var_txt_function text = 'application_summary_get_owner_summary';
