drop function if exists application_summary_get_administrator_view;

create or replace function application_summary_get_administrator_view (
...
declare
  ...
  var_txt_function text = 'application_summary_get_administrator_summary';
